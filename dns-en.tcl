...
foreach dns_say $dns_chan { puthelp "PRIVMSG $dns_say :The User@host of \037\002$dns_nick\017 is \037\002$dns_host\017 ." }
if {$dns_bynick == "oui"} {
...
foreach dns_say $dns_chan { puthelp "PRIVMSG $dns_say :\037\002$arg\017: No such nick." }
}
...
proc resolve_rep {ip host status chan hostip} {
        if {!$status} {
                puthelp "privmsg $chan :Unable to resolve \037\002$hostip\017 ."
        } elseif {[regexp -nocase -- $ip $hostip]} {
                puthelp "privmsg $chan :Resolved \037\002$ip\017 to \037\002$host\017 ."
        } else {
                puthelp "privmsg $chan :Resolved \037\002$host\017 to \037\002$ip\017 ."
        }
}

putlog "Dns Resolver 3.1 by I_strike Loaded"
